...
- `MS-4004_Finance_Prompt_Packet.md` or `MS-4004_Finance_Prompt_Packet.pdf`
- `Northstar_Life_Monthly_Performance.xlsx`
- `Northstar_Monthly_Review_Notes.docx`
- `Northstar_Claims_Committee_Thread.pdf`
...
This is a three-hour, instructor-led MS-4004 Finance use-case walkthrough with guided follow-alongs. There is no separate independent learner lab. The older lab guide and custom-skill package remain in this folder only as additional references.
